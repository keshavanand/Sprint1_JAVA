...
public class Runner {
	...
	public static void main(String[] args) {
		...
		//Casting Exercise
		List<FoodItem>  lowCalorieFoods = calorieCounter.getAllLowCalorieFoods();
		
		for(FoodItem food: lowCalorieFoods){
			if(food instanceof Snack){
				Snack snack = (Snack) food;
				System.out.println("Fat: "+snack.getFatContent()+" Sugar: "+snack.getSugarContent());
			}
			if(food instanceof ReadyMeal){
				ReadyMeal readyMeal = (ReadyMeal) food;
				System.out.println("Cuisine Type: "+readyMeal.getCuisineType());
			}
		}
